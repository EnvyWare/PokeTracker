...
public class PokeTrackerFactory {
    ...
    public static void catchPokemon(PixelmonEntity pixelmon, ServerPlayer catcher) {
    ...
    public static void defeatPokemon(PixelmonEntity pixelmon, ServerPlayer catcher) {
        for (List<EntityData> value : TRACKED_ENTITIES.values()) {
            for (EntityData entityData : value) {
